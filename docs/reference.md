...
[Back to the introduction](../README.md) · [Getting started](getting-started.md)
...
[stable configuration](configuration-conventions.md).
...
See the complete [new-project guide](getting-started.md) for issue-by-issue remediation, an AI
...
findings. See [`docs/performance.md`](performance.md) for the measured contract and
[`docs/operations.md`](operations.md) for lifecycle and security details.
...
See [measured detection limits](detection-quality.md) for supported cases and known misses.
...
[detection and adoption guide](detection-quality.md).
...
[`docs/plugins.md`](plugins.md) for a complete rule-pack entry-point example.
